...
ggplot(ac_dw_melt,aes(x=variable,y=value))+ geom_col(mapping = NULL, data = NULL, position = "stack",
  width = NULL, na.rm = FALSE, show.legend = NA, inherit.aes = TRUE)+ theme_bw()+ theme(legend.position="top",
              axis.text=element_text(angle=90, size = 6))+ labs(x="Countries", y= "access to safe drinking-water (%)")+ coord_cartesian(xlim= NULL,ylim = NULL, expand= TRUE)+geom_text(aes(label=variable),size=2,hjust=0.5,vjust=0)
warning= FALSE
```
...
ggplot(defi_food_melt,aes(x=variable,y=value))+geom_col(mapping = NULL, data = NULL, position = "stack",
  width = NULL, na.rm = FALSE, show.legend = NA, inherit.aes = TRUE) + coord_cartesian(xlim= NULL,ylim = NULL, expand= TRUE)+  theme(legend.position="top",
              axis.text=element_text(angle=90, size = 6))+ labs(x="Countries",y= "kcal/capita/day, 3yr avg",title= "Depth of the Food Deficit")+geom_text(aes(label=variable),size=2,hjust=0.5,vjust=0)
warning= FALSE
```
```{r}
...
ind_matrix_pca<- prcomp(ind_matrix_pca,center=TRUE, scale = TRUE)
...
ac_matrix_pca<- prcomp(ac_matrix_pca,center=TRUE, scale = TRUE)
