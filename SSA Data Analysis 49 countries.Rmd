...
#+ geom_hline(yintercept = avg_lt_ppt_c)
warning= FALSE
hist(ind_matrix_af$var_interan_c)
```
...
ind_wo_N_SA<-ind_matrix_af_ca[-c(29,33),]
...
# K-Means Cluster Analysis
fit_se <- kmeans(ind_wo_N_SA_ca_se, 5) # 5 cluster solution
# get cluster means 
