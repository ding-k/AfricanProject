...
Most obviously, South Africa is the outlier which is not suprising. While Mozambique and Lesotho are the two countries wrapped by South Africa, relatively closed to each other but varied significantly in deficit of food supply.
...
Compare to the independent matrix, the access matrix contains one less variable (6). The first three principal components counts for more than 93 percent of the total variance. The most siginificant component in pc1 is "total population have access to safe drinking water". In pc2, the energy per capita is the most significant component. In the pc3, deficit of food is the predominant variance. 
We can discuss those findings in the next meeting.
